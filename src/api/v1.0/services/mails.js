...
const blogPostEmailTemplate = (postTitle, slug, excerpt, postImage) => (
          ...
          <tr>
            <td data-bgcolor="bg-module" bgcolor="#eaeced">
              <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="img-flex"><img src=${postImage} style="vertical-align:top;" width="600" height="306" alt="" /></td>
                </tr>
                <tr>
                  <td data-bgcolor="bg-block" class="holder" style="padding:58px 60px 52px;" bgcolor="#f9f9f9">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td>
                          <p align="center"><span style="color: #f08080">&copy; 2020 Marblesofhameedah</span></p>
                        </td>
                      </tr?
                    </table>
                  </td>
...
exports.sendNewPostNotificationEmail = async (postTitle, slug, excerpt, postImage) => {
  const mailList = await allSubscribers();
  mailList.forEach((subscriber) => {
    const mailOptions = {
      from: process.env.ADMIN_EMAIL,
      to: subscriber,
      subject: `[New Post] ${postTitle} on Meedah\'s Marbles`,
      html: blogPostEmailTemplate(postTitle, slug, excerpt, postImage),
    };
    transporter.sendMail(mailOptions, (err) => {
      if (err) {
        console.log(err);
